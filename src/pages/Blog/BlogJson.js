...
export const allBlogDetailsData = [
  ...
  },
  {
    ...
    description:
      'Simply dummy text of the printing and typesetting industry. Simply dummy text of the printing and typesetting industry.',
    buttonName: 'Legal tax',
    name: 'Alice Johnson • 19 Jan 2023',
    bigImage: {
      src: blogcard3,
      alt: 'Big Blog Image',
    },
