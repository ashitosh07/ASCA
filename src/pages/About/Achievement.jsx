        ...
        >
          <div className='parent min-h-[90vh] flex flex-col lg:flex-row  items-center justify-between gap-8'>
            ...
            >
              ...
              >
                Access the full potential of our user dashboard, where clients
                can effortlessly upload documents and monitor task progress in
                real-time. Our secure document upload feature ensures the
                confidentiality of your information, with support for various
                file formats. The intuitive interface guarantees a user-friendly
                experience, allowing you to seamlessly navigate through the
                system and receive immediate updates on task progress. With
                robust security measures, including encryption and secure
                connections, your data is safeguarded at every step. Guidelines
                for optimal use are provided to assist you in organizing and
                managing your documents effectively. If you need assistance, our
                support team is just a message away, ensuring a smooth and
